...
if __name__=="__main__":
    ...
    parser.add_argument('--model-path', type=str, required=False, default="/home/sym/code/mycode/FastV/llava-v1.5-7b")
    parser.add_argument('--image-path', type=str, required=False, default='/home/sym/code/mycode/FastV/src/LLaVA/images/llava_logo.png')
    parser.add_argument('--prompt', type=str, required=False, default='discribe the image in detail')
    parser.add_argument('--output-path', type=str, default='/home/sym/code/mycode/FastV/output_example' , required=False, help='the path to save the output json file')
